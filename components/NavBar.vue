      ...
      >
        ...
        <div class="items-center md:flex">
          ...
          <div class="flex justify-center md:block">
            <button
              class="px-4 py-2 font-medium tracking-wide text-white bg-gradient-to-r from-purple-400 via-pink-500 to-red-500
              rounded-md hover:from-pink-500 hover:to-yellow-500
               "
            >
              Demander une démo
            </button>
